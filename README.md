...
- Windows 10 or later
- [.NET 10.0 Desktop Runtime](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) (or use the standalone build)
...
Download `AntiDrag.exe` from the `publish/` folder. Requires the .NET 10.0 Desktop Runtime to be installed.
